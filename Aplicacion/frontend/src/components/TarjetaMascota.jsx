    ...
    return (
        ...
        <div className="w-full bg-[#FFFFFF] rounded-lg shadow-md flex flex-col md:flex-row items-center p-4 gap-4 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
            ...
            <div className="flex-grow flex flex-col justify-between h-full w-full">
                <div>
                    <h2 className="text-xl md:text-2xl font-bold text-[#243B55]">
                        {nombre}
                    </h2>
                ...
                <button className="mt-3 w-full md:w-auto md:self-start inline-flex items-center justify-center gap-2 rounded-md bg-[#5f0f2a] px-4 py-2 text-white font-semibold shadow-md transition-all duration-200 hover:opacity-90 active:scale-95">
