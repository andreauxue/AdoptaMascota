    ...
    <footer className={`${color} py-10 text-white`}>
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* 2. Texto + Contacto + Enlaces legales */}
          <div className="flex flex-col items-center text-center">
            ...
            <div className="space-y-3 text-sm text-gray-200 mb-6">
              <div className="flex items-center justify-center gap-3">
                <MapPin size={18} className="text-verde-menta" />
                <span>Ciudad Universitaria</span>
              </div>
              <div className="flex items-center justify-center gap-3">
                <Mail size={18} className="text-verde-menta" />
                <span>adoptaUnAmigo@gmail.com</span>
              </div>
            </div>

            {/* Enlaces legales horizontales (no se cortan) */}
