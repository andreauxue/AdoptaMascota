...
export default function FormularioAuth({ tipo, onSubmit }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Llama a la función recibida como prop (por ejemplo loginUser o registerUser)
      await onSubmit(formData);

      // Limpia los campos tras el envío exitoso
        ...
        <div className="text-center mt-6 pt-6 border-t border-gray-200">
          <p className="text-gray-600">
            ...
            <button
              ...
              onClick={() =>
                console.log("Cambiar a:", tipo === "login" ? "register" : "login")
              }
            >
